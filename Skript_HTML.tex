...
\begin{document}
	...
	\def\pics{./pics}
	\rohead{}
	\input{./Arbeitsblaetter/Begriffe.tex}
	\newpage
    \input{./Arbeitsblaetter/Sonderzeichen.tex}
    \newpage
    \input{./Arbeitsblaetter/Validieren.tex}
    \newpage
    \input{./Arbeitsblaetter/Textauszeichnungen.tex}
    \newpage
    \input{./Arbeitsblaetter/CSS.tex}
    \newpage
    \input{./Arbeitsblaetter/Listen.tex}
    \newpage
    \input{./Arbeitsblaetter/Bilder.tex}
    \newpage
    \input{./Arbeitsblaetter/Abschnitte.tex}
    \newpage
    \input{./Arbeitsblaetter/Links.tex}
    \newpage
    \input{./Arbeitsblaetter/Tabellen.tex}    
    \newpage
    \input{./Arbeitsblaetter/Hover.tex}
    \newpage
